                ...
                <Flex className='ContieneTodo' height="75vh" width="95vw" alignItems="center" justifyContent="center">
                    ...
                    <Flex className='Detalles' display="grid">
                        ...
                        <Grid templateColumns='repeat(5, 1fr)' gap={6} pb='5'>
                            <Button colorScheme='gray' variant='outline'>7 US</Button>
                            <Button colorScheme='gray' variant='outline'>7.5 US</Button>
                            <Button colorScheme='gray' variant='outline'>8 US</Button>
                            <Button colorScheme='gray' variant='outline'>8.5 US</Button>
                            <Button colorScheme='gray' variant='outline'>9 US</Button>
                            <Button colorScheme='gray' variant='outline'>9.5 US</Button>
                            <Button colorScheme='gray' variant='outline'>10 US</Button>
                            <Button colorScheme='gray' variant='outline'>10.5 US</Button>
                            <Button colorScheme='gray' variant='outline'>11 US</Button>
                            <Button colorScheme='gray' variant='outline'>12 US</Button>
                        </Grid>
