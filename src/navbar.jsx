            ...
            <div className='parteSuperior'>
                <div className='contenedor-1'>
                    ...
                    <button className='submit'><img src={search} alt="Buscar" /></button> */}
                        <form onSubmit={handleSubmit}>
                            <input className='buscador' type="text" placeholder='  Buscar...' value={query}
                    ...
                    <div className='contenedor-session'>
                        <div className='user' onMouseEnter={handleUserEnter} onMouseLeave={handleUserLeave}>
                            <img src={user} alt=""/>
                            {showUserMenu && (
                                <div id="userDropdown" className="dropdown-content" onMouseEnter={handleUserEnter}
                                    ...
                                    <a href="#" className='decoracion-enlace nombre2'
                                       onClick={() => navigate('/products')}>Mis Productos</a>
                        ...
                        <button className='carrito' onClick={toggleCarrito}>
                            ...
                            {productos.length > 0 &&
                                <Badge ml='1' fontSize='0.8em' colorScheme='green'>{productos.length}</Badge>
                            }
                                </button>
                ...
                <div className="contenedor-2">
                    <div className="menu" onMouseEnter={handleMouseEnter} onMouseLeave={handleMouseLeave}>
                        ...
                        <div className="nombre menu1" onMouseEnter={handleMouseEnter}
                             onMouseLeave={handleMouseLeave}>Estilo
                        </div>
                        <ul className={`submenu uno ${menuVisible ? 'show' : ''}`} onMouseEnter={handleSubmenuEnter}
                            onMouseLeave={handleSubmenuLeave}>
                            <div className="submenu-column menu1">
